...
namespace HR_Management.Persistence.Migrations
{
    ...
    [Migration("20251002082921_AddHoursPerDayToLeaveType")]
    partial class AddHoursPerDayToLeaveType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HR_Management.Domain.LeaveStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2025, 10, 2, 8, 29, 18, 498, DateTimeKind.Utc).AddTicks(6605),
                            Name = "Pending"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2025, 10, 2, 8, 29, 18, 498, DateTimeKind.Utc).AddTicks(6608),
                            Name = "Approved"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2025, 10, 2, 8, 29, 18, 498, DateTimeKind.Utc).AddTicks(6609),
                            Name = "Rejected"
                        },
                        new
                        {
                            Id = 4,
                            DateCreated = new DateTime(2025, 10, 2, 8, 29, 18, 498, DateTimeKind.Utc).AddTicks(6610),
                            Name = "Cancelled"
                        });
                });
            ...
            modelBuilder.Entity("HR_Management.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2025, 10, 2, 8, 29, 18, 498, DateTimeKind.Utc).AddTicks(6540),
                            DefaultDay = 26,
                            HoursPerDay = 0,
                            Name = "Annual Leave"
                        },
                        ...
                        {
                            Id = 2,
                            DateCreated = new DateTime(2025, 10, 2, 8, 29, 18, 498, DateTimeKind.Utc).AddTicks(6543),
                            DefaultDay = 7,
                            HoursPerDay = 0,
                            Name = "Sick Leave"
                        },
                        ...
                        {
                            Id = 3,
                            DateCreated = new DateTime(2025, 10, 2, 8, 29, 18, 498, DateTimeKind.Utc).AddTicks(6544),
                            DefaultDay = 0,
                            HoursPerDay = 0,
                            Name = "Hourly Leave"
                        },
                        ...
                        {
                            Id = 4,
                            DateCreated = new DateTime(2025, 10, 2, 8, 29, 18, 498, DateTimeKind.Utc).AddTicks(6545),
                            DefaultDay = 3,
                            HoursPerDay = 0,
                        ...
                        {
                            Id = 5,
                            DateCreated = new DateTime(2025, 10, 2, 8, 29, 18, 498, DateTimeKind.Utc).AddTicks(6546),
                            DefaultDay = 90,
                            HoursPerDay = 0,
                        ...
                        {
                            Id = 6,
                            DateCreated = new DateTime(2025, 10, 2, 8, 29, 18, 498, DateTimeKind.Utc).AddTicks(6548),
                            DefaultDay = 30,
                            HoursPerDay = 0,
                            Name = "Unpaid Leave"
                        });
            ...
            modelBuilder.Entity("HR_Management.Domain.PasswordResetToken", b =>
                {
                    ...
                    b.Property<DateTime>("CreateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 10, 2, 8, 29, 18, 497, DateTimeKind.Utc).AddTicks(4470));
            ...
            modelBuilder.Entity("HR_Management.Domain.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2025, 10, 2, 11, 59, 18, 498, DateTimeKind.Local).AddTicks(6382),
                            Name = "Employee"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2025, 10, 2, 11, 59, 18, 498, DateTimeKind.Local).AddTicks(6395),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2025, 10, 2, 11, 59, 18, 498, DateTimeKind.Local).AddTicks(6397),
                            Name = "HR"
                        },
                        new
                        {
                            Id = 4,
                            DateCreated = new DateTime(2025, 10, 2, 11, 59, 18, 498, DateTimeKind.Local).AddTicks(6398),
                            Name = "Manager"
                        });
                });
            ...
            modelBuilder.Entity("HR_Management.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CountryCode = 98,
                            CreatedAt = new DateTime(2025, 10, 2, 11, 59, 18, 498, DateTimeKind.Local).AddTicks(6439),
                            DateCreated = new DateTime(2025, 10, 2, 8, 29, 18, 498, DateTimeKind.Utc).AddTicks(6436),
