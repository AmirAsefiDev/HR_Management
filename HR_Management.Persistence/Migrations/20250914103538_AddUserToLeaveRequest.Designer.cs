...
namespace HR_Management.Persistence.Migrations
{
    ...
    [Migration("20250914103538_AddUserToLeaveRequest")]
    partial class AddUserToLeaveRequest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HR_Management.Domain.LeaveStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2025, 9, 14, 14, 5, 37, 824, DateTimeKind.Local).AddTicks(2724),
                            Name = "Pending"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2025, 9, 14, 14, 5, 37, 824, DateTimeKind.Local).AddTicks(2728),
                            Name = "Approved"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2025, 9, 14, 14, 5, 37, 824, DateTimeKind.Local).AddTicks(2729),
                            Name = "Rejected"
                        },
                        new
                        {
                            Id = 4,
                            DateCreated = new DateTime(2025, 9, 14, 14, 5, 37, 824, DateTimeKind.Local).AddTicks(2730),
                            Name = "Cancelled"
                        });
                });
            ...
            modelBuilder.Entity("HR_Management.Domain.PasswordResetToken", b =>
                {
                    ...
                    b.Property<DateTime>("CreateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 9, 14, 10, 35, 37, 823, DateTimeKind.Utc).AddTicks(2344));
            ...
            modelBuilder.Entity("HR_Management.Domain.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2025, 9, 14, 14, 5, 37, 824, DateTimeKind.Local).AddTicks(2548),
                            Name = "Employee"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2025, 9, 14, 14, 5, 37, 824, DateTimeKind.Local).AddTicks(2550),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2025, 9, 14, 14, 5, 37, 824, DateTimeKind.Local).AddTicks(2552),
                            Name = "HR"
                        },
                        new
                        {
                            Id = 4,
                            DateCreated = new DateTime(2025, 9, 14, 14, 5, 37, 824, DateTimeKind.Local).AddTicks(2554),
                            Name = "Manager"
                        });
                });
            ...
            modelBuilder.Entity("HR_Management.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 9, 14, 14, 5, 37, 824, DateTimeKind.Local).AddTicks(2597),
                            DateCreated = new DateTime(2025, 9, 14, 14, 5, 37, 824, DateTimeKind.Local).AddTicks(2593),
                            FullName = "Amir Asefi",
                            IsActive = true,
                            Mobile = "9123456789",
