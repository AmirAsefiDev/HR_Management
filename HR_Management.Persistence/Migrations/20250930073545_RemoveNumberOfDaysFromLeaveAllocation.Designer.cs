...
namespace HR_Management.Persistence.Migrations
{
    ...
    [Migration("20250930073545_RemoveNumberOfDaysFromLeaveAllocation")]
    partial class RemoveNumberOfDaysFromLeaveAllocation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HR_Management.Domain.LeaveStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2025, 9, 30, 7, 35, 45, 133, DateTimeKind.Utc).AddTicks(9756),
                            Name = "Pending"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2025, 9, 30, 7, 35, 45, 133, DateTimeKind.Utc).AddTicks(9762),
                            Name = "Approved"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2025, 9, 30, 7, 35, 45, 133, DateTimeKind.Utc).AddTicks(9764),
                            Name = "Rejected"
                        },
                        new
                        {
                            Id = 4,
                            DateCreated = new DateTime(2025, 9, 30, 7, 35, 45, 133, DateTimeKind.Utc).AddTicks(9765),
                            Name = "Cancelled"
                        });
                });
            ...
            modelBuilder.Entity("HR_Management.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2025, 9, 30, 7, 35, 45, 133, DateTimeKind.Utc).AddTicks(9697),
                            DefaultDay = 26,
                            Name = "Annual Leave"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2025, 9, 30, 7, 35, 45, 133, DateTimeKind.Utc).AddTicks(9704),
                            DefaultDay = 7,
                            Name = "Sick Leave"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2025, 9, 30, 7, 35, 45, 133, DateTimeKind.Utc).AddTicks(9706),
                            DefaultDay = 0,
                            Name = "Hourly Leave"
                        },
                        new
                        {
                            Id = 4,
                            DateCreated = new DateTime(2025, 9, 30, 7, 35, 45, 133, DateTimeKind.Utc).AddTicks(9708),
                            DefaultDay = 3,
                            Name = "Marriage & Bereavement Leave"
                        },
                        new
                        {
                            Id = 5,
                            DateCreated = new DateTime(2025, 9, 30, 7, 35, 45, 133, DateTimeKind.Utc).AddTicks(9710),
                            DefaultDay = 90,
                        ...
                        {
                            Id = 6,
                            DateCreated = new DateTime(2025, 9, 30, 7, 35, 45, 133, DateTimeKind.Utc).AddTicks(9715),
                            DefaultDay = 30,
                            Name = "Unpaid Leave"
                        });
                });
            ...
            modelBuilder.Entity("HR_Management.Domain.PasswordResetToken", b =>
                {
                    ...
                    b.Property<DateTime>("CreateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 9, 30, 7, 35, 45, 132, DateTimeKind.Utc).AddTicks(5087));
            ...
            modelBuilder.Entity("HR_Management.Domain.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2025, 9, 30, 11, 5, 45, 133, DateTimeKind.Local).AddTicks(9427),
                            Name = "Employee"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2025, 9, 30, 11, 5, 45, 133, DateTimeKind.Local).AddTicks(9446),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2025, 9, 30, 11, 5, 45, 133, DateTimeKind.Local).AddTicks(9448),
                            Name = "HR"
                        },
                        new
                        {
                            Id = 4,
                            DateCreated = new DateTime(2025, 9, 30, 11, 5, 45, 133, DateTimeKind.Local).AddTicks(9450),
                            Name = "Manager"
                        });
                });
            ...
            modelBuilder.Entity("HR_Management.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CountryCode = 98,
                            CreatedAt = new DateTime(2025, 9, 30, 11, 5, 45, 133, DateTimeKind.Local).AddTicks(9555),
                            DateCreated = new DateTime(2025, 9, 30, 7, 35, 45, 133, DateTimeKind.Utc).AddTicks(9550),
