...
namespace HR_Management.Persistence.Migrations
{
    ...
    [Migration("20250903162731_AddPasswordResetToken")]
            ...
            modelBuilder.Entity("HR_Management.Domain.PasswordResetToken", b =>
                {
                    ...
                    b.Property<DateTime>("CreateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 9, 3, 16, 27, 31, 505, DateTimeKind.Utc).AddTicks(643));
            ...
            modelBuilder.Entity("HR_Management.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 9, 3, 19, 57, 31, 505, DateTimeKind.Local).AddTicks(7438),
                            FullName = "Amir Asefi",
                            IsActive = true,
                            Mobile = "9123456789",
